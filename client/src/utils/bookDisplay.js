...
export const DEPARTMENTS = [
  ...
  { value: "Ayurveda",       label: "Ayurveda",                faculty: "Medical & Allied Health" }, // ✅ FIXED
...
export const getFacultyLabel  = (value) => FACULTIES.find((f) => f.value === value)?.label  || value;
export const getDepartmentLabel = (value) => DEPARTMENTS.find((d) => d.value === value)?.label || value;
export const getFacultyEmoji  = (value) => FACULTIES.find((f) => f.value === value)?.emoji  || "📁";
